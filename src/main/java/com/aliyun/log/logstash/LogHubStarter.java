...
public class LogHubStarter {
    ...
    public static void startWorker(String endpoint, String accessId, String accessKey,
                                   ...
                                   String consumerGroup, String consumer, String position, int checkpointSecond, boolean includeMeta, int queueSize) throws LogHubClientWorkerException, InterruptedException {
