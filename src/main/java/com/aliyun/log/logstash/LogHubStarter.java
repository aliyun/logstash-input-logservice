...
public class LogHubStarter {
    ...
    public static void startWorker(ILogHubProcessor processor,
                                   String endpoint, String accessId, String accessKey,
                                   String project, String logstore,
                                   String consumerGroup, String consumer, String position) throws LogHubClientWorkerException, InterruptedException {
